...
import { getModuleActivities } from "../../../admin/api/activities";
...
export const ActivitiesDropdown: React.FC<ActivitiesDropdownProps> = ({ id, token, onSelect }) => {
  ...
  return (
    <div>
      ...
      <select id="activity-select" value={selectedId} onChange={handleChange}>
